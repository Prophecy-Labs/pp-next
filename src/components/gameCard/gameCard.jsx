            ...
            <div className={clsx(styles.game__card, backgroundClass)}>
                ...
                <div className={styles['game-hover__div']}>
                    ...
                    <div className={styles['bottom-icons']}>
                        <svg className={styles['bottom-icon']} onClick={handleClickEditor} xmlns="http://www.w3.org/2000/svg" width="56" height="70" viewBox="0 0 56 70" fill="none">
                        ...
                        <svg className={styles['bottom-icon']} xmlns="http://www.w3.org/2000/svg" width="47" height="58" viewBox="0 0 47 58" fill="none">
